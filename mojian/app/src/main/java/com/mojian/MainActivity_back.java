 ...
 * @author baishixian
 */
public class MainActivity_back extends AppCompatActivity implements View.OnClickListener {

    public static final String TAG = MainActivity_back.class.getSimpleName();
    ...
    MessageQueue.IdleHandler idleHandler = new MessageQueue.IdleHandler() {
        ...
        public boolean queueIdle() {
            ...
            if (classifier == null) {
                // 创建 Classifier
               classifier = TensorFlowImageClassifier.create(MainActivity_back.this.getAssets(),
    ...
    private void showNeedStoragePermissionDialog() {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override public void onClick(DialogInterface dialog, int which) {
                        ActivityCompat.requestPermissions(MainActivity_back.this,
    ...
    private void openSystemCamera() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            currentTakePhotoUri = FileProvider.getUriForFile(this, "com.mojian.fileprovider", photoFile);
    ...
    private void handleInputPhoto(Uri imageUri) {
        // 加载图片
        Glide.with(MainActivity_back.this).asBitmap().listener(new RequestListener<Bitmap>() {

            @Override
            public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Bitmap> target, boolean isFirstResource) {
                Log.d(TAG,"handleInputPhoto onLoadFailed");
                Toast.makeText(MainActivity_back.this, "图片加载失败", Toast.LENGTH_SHORT).show();
                return false;
            }
